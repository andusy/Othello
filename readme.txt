...
Rules:
Game Set-up
-The dimension of the game board is 8X8.
-Initially, the game will be set-up with 2 black disks and 2 white disks at the centre of the board.  They are arranged with black forming a North-East to South-West direction and white forming the North-West to South-East direction.  This is illustrated in Figure 1 below.

Making Moves 
-Black always moves first
-A move is made by placing a disk of the player’s colour on the board in a space that is adjacent horizontally, vertically or diagonally to an existing disk.   In Figure 2 below, ? marks all the valid spaces for the next move.
